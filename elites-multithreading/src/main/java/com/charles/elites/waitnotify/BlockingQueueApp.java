package com.charles.elites.waitnotify;
 ...
 * calls being synchronized on the "same" objects).
 ...
 * <br>
 * By synchronizing on a shared objects, you can ensure that this problem does
 ...
 * <br><br>
 * More: In order to wait on an objects, we must be synchronized on that objects.
 * <br>
 ...
 * thread calls {@code notify()} on the objects that we're waiting on (in this
...
class BlockingQueue<T> {
    ...
    public void put(T element) throws InterruptedException {
        ...
        try {
            ...
            notEmpty.signal(); //calls waiting thread on the same objects
        } finally {
            lock.unlock();
        }
    }
    ...
    public T take() throws InterruptedException {
        ...
        try {
            ...
            notFull.signal(); //calls waiting thread on same objects
            return item;
        } finally {
            lock.unlock();
        }
